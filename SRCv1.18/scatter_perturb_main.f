...
c************** that interface with S.Machado's "perturb" code **********
c************** Any additional routines are also included here **********
c************************************************************************
c************* THis is based on scatter_twostream_main.f ****************
c************************************************************************
...
c NO temperature variations in a layer, which should be more 
c more important in the lower wavenumbers (far infrared and sub mm)
c NO solar radiation, which would be important in near IR and vis
...
c        DO iF = 1,iNumLayer
c          iL = iaaRadLayer(iAtm,iF)
c          print *,iF,iL,raaExtTemp(1,iL),raaScatTemp(1,iL),raaAsymTemp(1,iL)
c         END DO
