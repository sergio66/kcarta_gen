c ************************************************************************
c ******************* THESE ARE THE DISORT ROUTINES **********************
c ************************************************************************
ccccccccc cp BDREF.f /salsify/users/sergio/KCARTA/SRCv1.08/
...
c      WRITE ( *, '(//,7(1X,A,/))' )
c     &  'To use a bidirectionally reflecting lower boundary you must',
c     &  'replace file BDREF.f with your own file. In that file, you ',
c     &  'should supply the bidirectional reflectivity, as a function ',
c     &  'of the cosine of angle of reflection, the cosine of angle ',
c     &  'of incidence, and the difference of azimuth angles of ',
c     &  'incidence and reflection. See DISORT.doc for more information',
c     &  'and subroutine BDREF in file DISOTEST.f for an example.'
c      CALL ERRMSG( 'BDREF--Please supply a surface BDRF model', .TRUE. )
c      BDREF = 0.0

c this is just 1 = e + b
