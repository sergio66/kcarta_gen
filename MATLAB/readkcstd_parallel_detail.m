function [data, wnums, caVersion, detail] = readkcstd_parallel_detail(kfile, dfile)
...
for chunk = 1:nchunk
  ...
  for odb = 1:nODBs
    ...
    fprintf(1,' ODBtype,subtype = %3i %3i numpts = %3i  start/stop freq = %8.6f %8.6f \n',type,subtype,ncols,frlow,frhigh)
