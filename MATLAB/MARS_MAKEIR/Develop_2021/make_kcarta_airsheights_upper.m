...
fid = fopen('/home/sergio/KCARTA/INCLUDE/MARS_database_params_2021/airsheights_upper.param_mars','w');
...
fprintf(fid,'%s \n',str);
str = 'c Sergio Machado UMBC May2021';
fprintf(fid,'%s \n\n',str);
...
str = ' ';
fprintf(fid,'%s \n',str);
str = '       INTEGER iXPlanet7';
fprintf(fid,'%s \n',str);
str = '       DATA iXPlanet7 /04/';
fprintf(fid,'%s \n',str);
str = ' ';
fprintf(fid,'%s \n',str);
