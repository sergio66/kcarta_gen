...
SUBROUTINE output4(iaPrinter,iaGPMPAtm,iaNp, iaaOp,raaOp,raaUserPress,  &
...
INTEGER, PARAMETER :: kMaxPrT=kMaxPrint+1
...
!if initially -1, it is left as -1 if ALL paths to be output
    CALL Read1(iGS,iNp,iNpmix,iMPSets,iAtm,  &
        iList,iListType,iaGPMPAtmT,iaNpT,iOutTypes,iPrinter, iNumGases,iaGasID)
  END IF
...
SUBROUTINE DoSetSome(iaOp,iList,iNp,iPrinter,iNumGases,iaGasID, iMPSets,iGS)
...
INTEGER, INTENT(IN)                      :: iaGasID(kMaxGas)
INTEGER, INTENT(IN OUT)                  :: iMPSets
...
INTEGER, INTENT(OUT)                     :: iaPrinter(kMaxPrint)
INTEGER, INTENT(IN)                      :: iaPrinterT(kMaxPrT)
INTEGER, INTENT(OUT)                     :: iaGPMPAtm(kMaxPrint)
INTEGER, INTENT(IN)                      :: iaGPMPAtmT(kMaxPrT)
INTEGER, INTENT(OUT)                     :: iaNp(kMaxPrint)
INTEGER, INTENT(IN)                      :: iaNpT(kMaxPrT)
INTEGER, INTENT(OUT)                     :: iaaOp(kMaxPrint,kPathsOut)
INTEGER, INTENT(IN)                      :: iaaOpT(kMaxPrT,kPathsOut)
REAL, INTENT(OUT)                        :: raaOp(kMaxPrint,kPathsOut)
REAL, INTENT(IN)                         :: raaOpT(kMaxPrT,kPathsOut)
NO TYPE, INTENT(IN OUT)                  :: raaUserPre
NO TYPE, INTENT(IN OUT)                  :: raaUserPre
...
INTEGER, INTENT(OUT)                     :: iNatm2
INTEGER, INTENT(OUT)                     :: iListType
INTEGER, INTENT(OUT)                     :: iaGPMPAtmT(kMaxPrT)
INTEGER, INTENT(OUT)                     :: iaNpT(kMaxPrT)
INTEGER, INTENT(IN OUT)                  :: iOutTypes
INTEGER, INTENT(OUT)                     :: iaPrinterT(kMaxPrT)
INTEGER, INTENT(IN)                      :: iPrinter
IMPLICIT NONE
...
INTEGER, INTENT(IN OUT)                  :: iGS
INTEGER, INTENT(IN)                      :: iNp
INTEGER, INTENT(IN OUT)                  :: iNpmix
INTEGER, INTENT(OUT)                     :: iMPSets
INTEGER, INTENT(OUT)                     :: iAtm
INTEGER, INTENT(IN OUT)                  :: iList
INTEGER, INTENT(IN OUT)                  :: iListType
INTEGER, INTENT(OUT)                     :: iaGPMPAtmT(kMaxPrT)
INTEGER, INTENT(OUT)                     :: iaNpT(kMaxPrT)
INTEGER, INTENT(IN OUT)                  :: iOutTypes
INTEGER, INTENT(IN OUT)                  :: iPrinter
...
INTEGER, INTENT(IN OUT)                  :: iOutTypes
INTEGER, INTENT(IN OUT)                  :: iPrinter
NO TYPE, INTENT(IN)                      :: iNumGases
INTEGER, INTENT(IN OUT)                  :: iaGasID(kMaxGas)
IMPLICIT NONE
...
SUBROUTINE ReCheck_iNp(iList,iListType,iGS,iNp, iMPSets,iNumGases,iPrinter)
...
INTEGER, INTENT(OUT)                     :: iaaOpT(kMaxPrT,kPathsOut)
REAL, INTENT(OUT)                        :: raaOpT(kMaxPrT,kProfLayer)
INTEGER, INTENT(IN OUT)                  :: iOutTypes
NO TYPE, INTENT(IN OUT)                  :: raaUserPre
...
INTEGER, INTENT(IN OUT)                  :: iNp
INTEGER, INTENT(OUT)                     :: iaNpT(kMaxPrT)
INTEGER, INTENT(IN OUT)                  :: iaPrinterT(kMaxPrT)
INTEGER, INTENT(IN OUT)                  :: iNatm
INTEGER, INTENT(IN OUT)                  :: iAtm
INTEGER, INTENT(IN OUT)                  :: iaGPMPAtmT(kMaxPrT)
REAL, INTENT(OUT)                        :: raaOpT(kMaxPrT,kProfLayer)
NO TYPE, INTENT(IN OUT)                  :: raaUserPre
INTEGER, INTENT(IN)                      :: iaNumLayer(kMaxAtm)
...
INTEGER, INTENT(IN OUT)                  :: iaOp1(kPathsOut)
INTEGER, INTENT(IN)                      :: iaOp2(kPathsOut)
...
INTEGER, INTENT(IN OUT)                  :: ia1(kPathsOut)
INTEGER, INTENT(IN OUT)                  :: ia2(kPathsOut)
REAL, INTENT(IN OUT)                     :: ra1(kProfLayer)
REAL, INTENT(IN OUT)                     :: ra2(kProfLayer)
...
SUBROUTINE DoMergePress(rP,raPRes,i2,iaRes,r2,raRes,iSum, iUD,iNew)


REAL, INTENT(IN)                         :: rP
REAL, INTENT(OUT)                        :: raPRes(kProfLayer)
INTEGER, INTENT(IN)                      :: i2
INTEGER, INTENT(OUT)                     :: iaRes(kPathsOut)
REAL, INTENT(IN)                         :: r2
REAL, INTENT(OUT)                        :: raRes(kProfLayer)
INTEGER, INTENT(OUT)                     :: iSum
INTEGER, INTENT(IN OUT)                  :: iUD
...
INTEGER, INTENT(IN OUT)                  :: iAtm
INTEGER, INTENT(IN OUT)                  :: iOutTypes
REAL, INTENT(IN)                         :: raPress(kProfLayer)
INTEGER, INTENT(IN)                      :: iNp
REAL, INTENT(IN)                         :: raaPrBdry(kMaxAtm,2)
NO TYPE, INTENT(IN OUT)                  :: raaUserPre
NO TYPE, INTENT(IN OUT)                  :: raPressLev
...
!            print *,'aha : top layer for up look instr!!!!!!'
  ...
  IF ((iaOp(iI) > iaNumLayer(iAtm)).OR.(iaOp(iI) < 1))THEN
    WRITE(kStdErr,*) 'iaaRadLayer(iAtm,1),iOne,=', iaaRadLayer(iAtm,1),iOne
    WRITE(kStdErr,*) 'iI,iaOp(iI) = ',iI,iaOp(iI)
