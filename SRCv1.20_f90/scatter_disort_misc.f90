...
! ************************************************************************
!cccccccc cp BDREF.f /salsify/users/sergio/KCARTA/SRCv1.08/
...
REAL, INTENT(IN OUT)                     :: MUP
REAL, INTENT(IN OUT)                     :: DPHI
...
DATA HAZELM /  2.41260, 3.23047, 3.37296, 3.23150, 2.89350,  &
    ...
    0.00006, 0.00005, 0.00004, 0.00004, 0.00003, 0.00003, 3*0.00002, 8*0.00001 /
...
IF ( NMOM < 2 ) CALL ERRMSG( 'GETMOM--bad input variable NMOM',.TRUE.)
