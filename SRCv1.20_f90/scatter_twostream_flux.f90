...
SUBROUTINE scatterfluxes_twostream( raFreq,raaAbs,raVTemp,caFluxFile,  &
...
CALL flux_twostream(raFreq,raVTemp,  &
    raaAbs,rTSpace,rTSurf,rSurfPress,raUseEmissivity, rAngle,rFracTop,rFracBot,  &
...
CALL AddCloud_twostream(raFreq,raaExtTemp,raaScatTemp,raaAsymTemp,  &
    iaaRadLayer,iAtm,iNumlayer,rFracTop,rFracBot, ICLDTOPKCARTA, ICLDBOTKCARTA,  &
...
!!!instrument looks down, so it measures UPWARD flux
  CALL all_radiances_twostream( raFreq,raaExtTemp,raaScatTemp,raaAsymTemp,  &
...
SUBROUTINE all_radiances_twostream( raFreq,raaExt,raaScat,raaAsym,  &
...
!ie this is intensity
    CALL SolarScatterIterate(iDoSolar,raSun,raFreq,raSunAngles,  &
        iNumLayer,iaRadLayer,rFracTop,rFracBot,iTag, iLocalCldTop,iLocalCldBot,  &
