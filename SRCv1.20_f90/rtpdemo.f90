...
! asl/opt/absoft/absoft10.0/bin/af77 -o rtpdemo.x -I/asl/packages/rtpV201_g80/include -w -W -C -O -A -N3 -s -f -N15 rtpdemo.f -L/asl/package
!************************************************************************
...
CHARACTER (LEN=130) :: caPFName !!!tells which profile
