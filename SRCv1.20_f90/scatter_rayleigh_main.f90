...
! this code uses asymmetry plus single scattering albedo plus SOLAR beam
    ...
    RETURN
  END SUBROUTINE doscatter_rayleigh
  
!************************************************************************
! interface to rayleigh plus SOLAR
...
!        END IF
  ...
  iCloudySky = 1
! if CloudySky > 0 then go ahead with kRayleigh!
...
!        print *,iaCldTop(1),iaCldbot(1)
!        print *,iaCldTop(2),iaCldbot(2)
!        print *,ICLDTOPKCARTA,ICLDBOTKCARTA
!        call DoStop
    
    CALL AddRayleigh( raFreq,iaaRadLayer,iAtm,iNumlayer,rFracTop,rFracBot,  &
  ...
  RETURN
END SUBROUTINE interface_rayleigh_solar
