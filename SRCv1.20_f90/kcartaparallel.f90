...
INTEGER :: iDummy,iDummy2,iDummy3,iFound,iWhichChunk,NewDataChunk,iFr
...
CHARACTER (LEN=1) :: 20)      :: NAME     ! Fortran 90
CHARACTER (LEN=255) :: :: name255  ! Fortran 90
CHARACTER (LEN=1) :: 32) :: homedir
...
CALL PrepareOutput(caDriverName,caOutName,caJacobFile,caJacobFile2, &
    ...
    iJacob,iaJacob, iakSolar,rakSolarAngle,rakSolarRefl,iakThermal,              &
