...
for hhcc = 1 : 3
  ...
  % -rwxrwxr-x 1 sergio pi_sergio  5327416 Feb 22 08:43 kcarta.x90_v1.22_400ppmv_H24
  % -rwxrwxr-x 1 sergio pi_sergio  5326704 Feb 11 20:32 kcarta.x90_v1.22_400ppmv_H20
  % -rwxrwxr-x 1 sergio pi_sergio  5326704 Feb 11 20:29 kcarta.x90_v1.22_400ppmv_H16
  ...
  if iHIT == 2016
    ...
    kcartaexec = '/home/sergio/KCARTA/BIN/kcarta.x90_v1.22_400ppmv_H16';
  elseif iHIT == 2020
    kcartaexec = '/home/sergio/KCARTA/BIN/kcarta.x_f90_122_400ppmv_H20_orig605_805res';
    kcartaexec = '/home/sergio/KCARTA/BIN/kcarta.x90_v1.22_400ppmv_H20';  
  elseif iHIT == 2024
    kcartaexec = '/home/sergio/KCARTA/BIN/kcarta.x90_v1.22_400ppmv_H24';  
  end
  
  outnml = 'junk.nml';
  
  iaDo = 1 : length(f1);
  iaDo = [8];  %% IR 605-2830 cm-1
  ...
  if iMakeData > 0
    for iii = 1 : length(iaDo)
      ii = iaDo(iii);
      sedder = ['!sed -e "s/FF1/' num2str(f1(ii)) '/g"  -e "s/FF2/' num2str(f2(ii)) '/g" -e "s/xyzckd/' num2str(CKDCKD) '/g" '];
  ...
  if iReadData > 0
    ...
    for iii = 1 : length(iaDo)
      ...
      if exist(outname)
        ...
        saver = ['save ../L2SComparisons/l2s_kc122_H' num2str(iHIT-2000) '_' num2str(f1(ii)) '_' num2str(f2(ii)) '.mat d w iaGasID CKDCKD'];
        eval(saver);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
disp(' ')
disp('now look at compare_l2s_H16_H20.m OR compare_l2s_H16_H20_convolved.m')
