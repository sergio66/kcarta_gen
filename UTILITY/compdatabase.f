...
c update this subroutine when you add on new bands
...
c the tags are stored in ../INCLUDE/pre_defined.param
      ...
      IF (iCntF .GT. 0) THEN
        DO iInt=1,iCntF
          WRITE (11,2000) iInt,IFIX(raaArrF(iInt,1)),raaArrF(iInt,2),
     $                  raaArrF(iInt,3),iTag
          END DO
        CALL doBlock(raaArrF,iCntF,raaBlockF,iCnt2F)
        DO iInt=1,iCnt2F
          WRITE (12,2010) IFIX(raaBlockF(iInt,1)),raaBlockF(iInt,2),
     $                  raaBlockF(iInt,3),iTag
          WRITE (*,*) (raaBlockF(iInt,1)),raaBlockF(iInt,2),
     $                  raaBlockF(iInt,3),iTag
          END DO
        END IF
      ...
      IF (iCntG .GT. 0) THEN
        DO iInt=1,iCntG
          WRITE (11,2000) iInt,IFIX(raaArrG(iInt,1)),raaArrG(iInt,2),
     $                  raaArrG(iInt,3),iTag
          END DO
        CALL doBlock(raaArrG,iCntG,raaBlockG,iCnt2G)
        DO iInt=1,iCnt2G
          WRITE (12,2010) IFIX(raaBlockG(iInt,1)),raaBlockG(iInt,2),
     $                  raaBlockG(iInt,3),iTag
          WRITE (*,*) (raaBlockG(iInt,1)),raaBlockG(iInt,2),
     $                  raaBlockG(iInt,3),iTag
          END DO
        END IF
      ...
      IF (iCntH .GT. 0) THEN
        DO iInt=1,iCntH
          WRITE (11,2000) iInt,IFIX(raaArrH(iInt,1)),raaArrH(iInt,2),
     $                  raaArrH(iInt,3),iTag
          END DO
        CALL doBlock(raaArrH,iCntH,raaBlockH,iCnt2H)
        DO iInt=1,iCnt2H
          WRITE (12,2010) IFIX(raaBlockH(iInt,1)),raaBlockH(iInt,2),
     $                  raaBlockH(iInt,3),iTag
          WRITE (*,*) (raaBlockH(iInt,1)),raaBlockH(iInt,2),
     $                  raaBlockH(iInt,3),iTag
          END DO
        END IF
     ...
     $                  raaBlockJ(iInt,3),iTag
          WRITE (*,*) (raaBlockJ(iInt,1)),raaBlockJ(iInt,2),
     $                  raaBlockJ(iInt,3),iTag
          END DO
        END IF
     ...
     $                  raaBlockM(iInt,3),iTag
      ...
      IF (iCntN .GT. 0) THEN
        DO iInt=1,iCntN
          WRITE (11,2000) iInt,IFIX(raaArrN(iInt,1)),raaArrN(iInt,2),
     $                  raaArrN(iInt,3),iTag
          END DO
        CALL doBlock(raaArrN,iCntN,raaBlockN,iCnt2N)
        DO iInt=1,iCnt2N
          WRITE (12,2010) IFIX(raaBlockN(iInt,1)),raaBlockN(iInt,2),
     $                  raaBlockN(iInt,3),iTag
          END DO
        END IF

      IF (iCntO .GT. 0) THEN
        DO iInt=1,iCntO
          WRITE (11,2000) iInt,IFIX(raaArrO(iInt,1)),raaArrO(iInt,2),
     $                  raaArrO(iInt,3),iTag
          END DO
        CALL doBlock(raaArrO,iCntO,raaBlockO,iCnt2O)
        DO iInt=1,iCnt2O
          WRITE (12,2010) IFIX(raaBlockO(iInt,1)),raaBlockO(iInt,2),
     $                  raaBlockO(iInt,3),iTag
          END DO
        END IF

      IF (iCntV .GT. 0) THEN
        DO iInt=1,iCntV
          WRITE (11,2000) iInt,IFIX(raaArrV(iInt,1)),raaArrV(iInt,2),
     $                  raaArrV(iInt,3),iTag
          END DO
        CALL doBlock(raaArrV,iCntV,raaBlockV,iCnt2V)
        DO iInt=1,iCnt2V
          WRITE (12,2010) IFIX(raaBlockV(iInt,1)),raaBlockV(iInt,2),
     $                  raaBlockV(iInt,3),iTag
          END DO
        END IF

      IF (iCntU .GT. 0) THEN
        DO iInt=1,iCntU
          WRITE (11,2000) iInt,IFIX(raaArrU(iInt,1)),raaArrU(iInt,2),
     $                  raaArrU(iInt,3),iTag
          END DO
        CALL doBlock(raaArrU,iCntU,raaBlockU,iCnt2U)
        DO iInt=1,iCnt2U
          WRITE (12,2010) IFIX(raaBlockU(iInt,1)),raaBlockU(iInt,2),
     $                  raaBlockU(iInt,3),iTag
          END DO
        END IF
...
c************************************************************************
c************************************************************************
c just add on to this subroutine as needed
...
c local variables
      ...
      iCnt = iCnt+1
c      print *,'The file prefix and iCnt are : ',caStr(1:1),iCnt
