...
figure(1);
plot(w,[t12 t16 t20]); legend('H12','H16','H20');
plot(w,t20-t12,w,t20-t16); legend('H20-H12','H20-H16','location','best'); title('monochromatic kcarta')

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

addpath /home/sergio/git/matlabcode
[fc,qc] = quickconvolve(w,[d12 d16 d20],1,1); tc = rad2bt(fc,qc); tc12 = tc(:,1); tc16 = tc(:,2); tc20 = tc(:,3);

figure(2); 
plot(fc,[tc12 tc16 tc20]); legend('H12','H16','H20');
plot(fc,tc20-tc12,fc,tc20-tc16); legend('H20-H12','H20-H16','location','best'); title('gaussian FWHM = 1 cm-1')
