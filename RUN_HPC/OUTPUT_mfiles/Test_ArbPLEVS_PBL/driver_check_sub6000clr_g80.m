...
if ~exist('6555_profiles/PBL_G80/pbl_G80_summary.mat')
  ...
  for ii = 1 : nprof
    ...
    fin = ['6555_profiles/PBL_G80/individual_prof_convolved_kcarta_airs_' num2str(ii) '.mat'];
    if exist(fin)
      x = load(fin);
      pbl_kcarta(:,ii) = x.rKc;
      pbl_found(ii) = +1;
  ...
  save 6555_profiles/PBL_G80/pbl_G80_summary.mat pbl_found pbl_kcarta fKc h2645

else
  load('6555_profiles/PBL_G80/pbl_G80_summary.mat');
end
...
if ~exist('6555_profiles/AIRS_G80/airs_G80_summary.mat')
  ...
  for ii = 1 : nprof
    ...
    fin = ['6555_profiles/AIRS_G80/individual_prof_convolved_kcarta_airs_' num2str(ii) '.mat'];
    if exist(fin)
      x = load(fin);
  ...
  save 6555_profiles/AIRS_G80/airs_G80_summary.mat airs_found airs_kcarta fKc h2645

else
  load('6555_profiles/AIRS_G80/airs_G80_summary.mat');
end
