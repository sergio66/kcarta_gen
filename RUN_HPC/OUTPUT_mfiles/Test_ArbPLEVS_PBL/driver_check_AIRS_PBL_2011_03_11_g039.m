...
[h,ha,psarta_clr_rad_airs,pa] = rtpread('/asl/s1/sergio/rtp/rtp_airicrad_v6/2011/03/11/clear_airs_l1c_test_2011.03.11.039_cumsum_-1_noclds_airs.rp.rtp');
...
if ~exist('PBL_2011_03_11_g039/pbl_summary.mat')
  ...
  pbl_kcarta = nan(2834,12150);
  pbl_found = zeros(1,12150);
  for ii = 1 : 12150
    if mod(ii,1000) == 0
      fprintf(1,'+')
    elseif mod(ii,100) == 0
    ...
    fin = ['PBL_2011_03_11_g039/individual_prof_convolved_kcarta_airs_' num2str(ii) '.mat'];
    if exist(fin)
      x = load(fin);
      pbl_kcarta(:,ii) = x.rKc;
      pbl_found(ii) = +1;
  ...
  save PBL_2011_03_11_g039/pbl_summary.mat pbl_found pbl_kcarta fKc h2645
  ...
  load('PBL_2011_03_11_g039/pbl_summary.mat');
end

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

if ~exist('AIRS_2011_03_11_g039/airs_summary.mat')
  ...
  airs_kcarta = nan(2834,12150);
  airs_found = zeros(1,12150);
  for ii = 1 : 12150
    if mod(ii,1000) == 0
      fprintf(1,'+')
    elseif mod(ii,100) == 0
    ...
    fin = ['AIRS_2011_03_11_g039/individual_prof_convolved_kcarta_airs_' num2str(ii) '.mat'];
    if exist(fin)
      x = load(fin);
  ...
  save AIRS_2011_03_11_g039/airs_summary.mat airs_found airs_kcarta fKc h2645
  ...
  plot(h.vchan,nanmean(tsarta_clr_rad_airs'-tairs'),'r',h.vchan,nanstd(tsarta_clr_rad_airs'-tairs'),'m'); plotaxis2;
    title('AIRS100 : still have wierd O3; NLTE is canned but not bad','fontsize',10)
  xlim([645 2780])
  xlim([645 1680])
else
  load('AIRS_2011_03_11_g039/airs_summary.mat');
end
