...
for lon = 1 : 72
  ...
  frad0 = ['AllDemJacsCld_Q09//individual_prof_convolved_kcarta_airs_' num2str(ind_subset_junk_ii) '.mat'];
  fz    = ['AllDemJacsCld_Q09//individual_prof_convolved_kcarta_airs_' num2str(ind_subset_junk_ii) '_jac.mat'];
  fcol  = ['AllDemJacsCld_Q09//individual_prof_convolved_kcarta_airs_' num2str(ind_subset_junk_ii) '_coljac.mat'];
...
kcarta.subjac.comment{2} = 'see ~/KCARTA/WORK/RUN_TARA/GENERIC_RADSnJACS_MANYPROFILES/JUNK/AIRS_gridded_Nov2022_startSept2002_endAug2022_trendsonly_cldy_Q09_v2/clust_put_together_jacs_cldERA5.m for ERA5';
