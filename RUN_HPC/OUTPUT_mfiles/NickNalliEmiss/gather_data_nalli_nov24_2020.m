...
[h,ha,pM0,pa] = rtpread('/home/sergio/KCARTA/WORK/RUN_TARA/GENERIC_RADSnJACS_MANYPROFILES/RTP/masuda_era_Nov24_2020.rp.rtp');
[h,ha,pMR,pa] = rtpread('/home/sergio/KCARTA/WORK/RUN_TARA/GENERIC_RADSnJACS_MANYPROFILES/RTP/masuda_resetTWV_era_Nov24_2020.rp.rtp');
[h,ha,pN0,pa] = rtpread('/home/sergio/KCARTA/WORK/RUN_TARA/GENERIC_RADSnJACS_MANYPROFILES/RTP/nalli_era_Nov24_2020.rp.rtp');
[h,ha,pNR,pa] = rtpread('/home/sergio/KCARTA/WORK/RUN_TARA/GENERIC_RADSnJACS_MANYPROFILES/RTP/nalli_resetTWV_era_Nov24_2020.rp.rtp');

dirM0 = 'Nov24_2020/MasudaEmis_OrigERA';
dirMR = 'Nov24_2020/MasudaEmis_ResetTWV';
dirN0 = 'Nov24_2020/NalliEmis_OrigERA';
dirNR = 'Nov24_2020/NalliEmis_ResetTWV';
...
results.masuda_efreq = pM0.efreq(1:19,:);
results.masuda_emis  = pM0.emis(1:19,:);
results.masuda_rho   = pM0.rho(1:19,:);
...
% save nalli_nov24_2020.mat results
