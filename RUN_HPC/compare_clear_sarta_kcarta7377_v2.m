...
fprintf(1,'length(CLEAR LIST ORIG) = %4i \n',length(clear_list))
...
clear_list = union(vf1n,vf1d);

%save new_clear_list vf1d vf1n

fprintf(1,'length(NEW CLEAR LIST) = %4i \n',length(clear_list))
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
