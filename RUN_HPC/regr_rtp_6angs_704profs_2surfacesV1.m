...
file1 = '/home/sergio/MATLABCODE/REGR_PROFILES/ECMWF_SAF_137Profiles/save_SAF_704_profiles_25-May-2016_xmb.op.rtp';
file2 = '/home/sergio/MATLABCODE/REGR_PROFILES/ECMWF_SAF_137Profiles/save_SAF_704_profiles_25-May-2016_1100mb.op.rtp';

[h,ha,p1,pa] = rtpread(file1);
for ii = 1 : length(p1.stemp);
  nlevs = p1.nlevs(ii);
  plevs = p1.plevs(1:nlevs,ii);
  palts = p1.palts(1:nlevs,ii);  
  salt(ii) = interp1(log(plevs),palts,log(p1.spres(ii)));
end
p1.salti = salt;
...
rtpwrite('/home/sergio/MATLABCODE/REGR_PROFILES/save_SAF_6angs_704profs_1013mb_seaemis.rtp',h,ha,p1out,pa);
fprintf(1,'spres, emis  %8.6f %8.6f \n',[p1out.spres(1) p1out.emis(1,1)])

p1out.emis = ones(size(p1out.emis));
p1out.rho  = zeros(size(p1out.emis));  
rtpwrite('/home/sergio/MATLABCODE/REGR_PROFILES/save_SAF_6angs_704profs_1013mb_unitemis.rtp',h,ha,p1out,pa);
fprintf(1,'spres, emis  %8.6f %8.6f \n',[p1out.spres(1) p1out.emis(1,1)])
...
rtpwrite('/home/sergio/MATLABCODE/REGR_PROFILES/save_SAF_6angs_704profs_1080mb_seaemis.rtp',h,ha,p2out,pa);
fprintf(1,'spres, emis  %8.6f %8.6f \n',[p2out.spres(1) p2out.emis(1,1)])

p2out.emis = ones(size(p2out.emis));
p2out.rho  = zeros(size(p2out.emis));  
rtpwrite('/home/sergio/MATLABCODE/REGR_PROFILES/save_SAF_6angs_704profs_1080mb_unitemis.rtp',h,ha,p2out,pa);
fprintf(1,'spres, emis  %8.6f %8.6f \n',[p2out.spres(1) p2out.emis(1,1)])
