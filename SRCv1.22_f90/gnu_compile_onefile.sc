echo " "
echo "to start"
echo "  (1) basic : only compile and link newly edited files, type               gnu_compile_onefile.sc"
echo "  (2) from scratch, except keep SAME ../INCLUDE files,  type   make clean; gnu_compile_onefile.sc"
