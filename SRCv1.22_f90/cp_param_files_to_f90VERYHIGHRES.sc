...
sed -e "s/pre_definedVERYHIGHRES_IR.param/pre_definedVERYHIGHRES_IRparam.f90/g" -e "s/post_defined.param/post_definedparam.f90/g" ../INCLUDE/TempF90/JunkTempDir/xkcartaparam.f90 > ../INCLUDE/TempF90/kcartaparam.f90; rm ../INCLUDE/TempF90/JunkTempDir/xkcartaparam.f90	../INCLUDE/TempF90/JunkTempDir/xkcartaparam.f

#########################
/bin/cp ../INCLUDE/pre_definedVERYHIGHRES_IR.param  ../INCLUDE/TempF90/JunkTempDir/pre_definedVERYHIGHRES_IRparam.f;  fixcon ../INCLUDE/TempF90/JunkTempDir/pre_definedVERYHIGHRES_IRparam.f  ../INCLUDE/TempF90/pre_definedVERYHIGHRES_IRparam.f90; rm ../INCLUDE/TempF90/JunkTempDir/pre_definedVERYHIGHRES_IRparam.f
#/bin/cp ../INCLUDE/TempF90/JunkTempDir/pre_definedHIGHRES_IR.param     ../INCLUDE/TempF90/JunkTempDir/pre_definedHIGHRES_IRparam.f;  fixcon ../INCLUDE/TempF90/JunkTempDir/pre_definedHIGHRES_IRparam.f  ../INCLUDE/TempF90/pre_definedHIGHRES_IRparam.f90; rm ../INCLUDE/TempF90/JunkTempDir/pre_definedHIGHRES_IRparam.f
