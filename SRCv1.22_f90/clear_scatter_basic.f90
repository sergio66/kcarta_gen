...
! ************* used to be in scatter_disort_misc ************************
! ************************************************************************
...
! ************************************************************************
    DOUBLE PRECISION FUNCTION  DBDREF( WVNMLO, WVNMHI, MU, MUP, DPHI )
...
!     .. Scalar Arguments ..
    ...
    DOUBLE PRECISION ::      DPHI, MU, MUP, WVNMHI, WVNMLO
!     ..
!     .. External Subroutines ..
...
! this is just 1 = e + b
    ...
    DBDREF = DBLE(DISORTraBiDirRefl(DISORTiI))

    RETURN
    END FUNCTION 

!************************************************************************
    SUBROUTINE  DGETMOM( IPHAS, GG, NMOM, PMOM )
...
!     .. Local Arrays ..
    ...
    DOUBLE PRECISION ::      CLDMOM( 299 ), HAZELM( 82 )
!     ..
!     .. External Subroutines ..
