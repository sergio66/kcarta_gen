...
sed -e "s/pre_definedVERYHIGHRES_IR.param/pre_definedVERYHIGHRES_IRparam.f90/g" -e "s/post_defined.param/post_definedparam.f90/g" ../INCLUDE/xkcartaparam.f90 > ../INCLUDE/kcartaparam.f90; rm ../INCLUDE/xkcartaparam.f90	../INCLUDE/xkcartaparam.f

/bin/cp ../INCLUDE/pre_definedVERYHIGHRES_IR.param  ../INCLUDE/pre_definedVERYHIGHRES_IRparam.f;  fixcon ../INCLUDE/pre_definedVERYHIGHRES_IRparam.f  ../INCLUDE/pre_definedVERYHIGHRES_IRparam.f90; rm ../INCLUDE/pre_definedVERYHIGHRES_IRparam.f
