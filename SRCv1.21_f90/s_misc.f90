...
! worry about NLTE
    ...
    ELSEIF ((iLineMix == 100) .OR. (iLineMix == 200) .OR. (iLineMix == 300) .OR. (iLineMix == 400)) THEN
      ca2 = '00'    !! solzen = 00
    ELSEIF ((iLineMix == 140) .OR. (iLineMix == 240) .OR. (iLineMix == 340) .OR. (iLineMix == 440)) THEN
      ca2 = '40'    !! solzen = 40
    ELSEIF ((iLineMix == 160) .OR. (iLineMix == 260) .OR. (iLineMix == 360) .OR. (iLineMix == 460)) THEN
      ca2 = '60'    !! solzen = 60
    ELSEIF ((iLineMix == 180) .OR. (iLineMix == 280) .OR. (iLineMix == 380) .OR. (iLineMix == 480)) THEN
      ca2 = '80'    !! solzen = 80
    ELSEIF ((iLineMix == 185) .OR. (iLineMix == 285) .OR. (iLineMix == 385) .OR. (iLineMix == 485)) THEN
      ca2 = '85'    !! solzen = 85
    ELSEIF ((iLineMix == 190) .OR. (iLineMix == 290) .OR. (iLineMix == 390) .OR. (iLineMix == 490)) THEN
      ca2 = '90'    !! solzen = 90
    END IF
