...
#########################
#/bin/cp ../INCLUDE/pre_definedHIGHRES_IR.param   ../INCLUDE/TempF90/JunkTempDir/xpre_definedHIGHRES_IRparam.f;  fixcon ../INCLUDE/TempF90/JunkTempDir/xpre_definedHIGHRES_IRparam.f  ../INCLUDE/TempF90/JunkTempDir/xpre_definedHIGHRES_IRparam.f90; rm ../INCLUDE/TempF90/JunkTempDir/xpre_definedHIGHRES_IRparam.f
...
#########################
/bin/cp ../INCLUDE/TempF90/Earth/airsheights.param             ../INCLUDE/TempF90/JunkTempDir/airsheightsparam.f;            fixcon ../INCLUDE/TempF90/JunkTempDir/airsheightsparam.f            ../INCLUDE/TempF90/airsheightsparam.f90;            rm ../INCLUDE/TempF90/JunkTempDir/airsheightsparam.f

/bin/cp ../INCLUDE/TempF90/Earth/airslevels.param              ../INCLUDE/TempF90/JunkTempDir/airslevelsparam.f;             fixcon ../INCLUDE/TempF90/JunkTempDir/airslevelsparam.f             ../INCLUDE/TempF90/airslevelsparam.f90;             rm ../INCLUDE/TempF90/JunkTempDir/airslevelsparam.f

/bin/cp ../INCLUDE/TempF90/Earth/airslevelheights.param        ../INCLUDE/TempF90/JunkTempDir/airslevelheightsparam.f;       fixcon ../INCLUDE/TempF90/JunkTempDir/airslevelheightsparam.f       ../INCLUDE/TempF90/airslevelheightsparam.f90;       rm ../INCLUDE/TempF90/JunkTempDir/airslevelheightsparam.f

/bin/cp ../INCLUDE/TempF90/Earth/airsheights_upper.param       ../INCLUDE/TempF90/JunkTempDir/airsheights_upperparam.f;      fixcon ../INCLUDE/TempF90/JunkTempDir/airsheights_upperparam.f      ../INCLUDE/TempF90/airsheights_upperparam.f90;      rm ../INCLUDE/TempF90/JunkTempDir/airsheights_upperparam.f

/bin/cp ../INCLUDE/TempF90/Earth/airslevels_upper.param        ../INCLUDE/TempF90/JunkTempDir/airslevels_upperparam.f;       fixcon ../INCLUDE/TempF90/JunkTempDir/airslevels_upperparam.f        ../INCLUDE/TempF90/airslevels_upperparam.f90;      rm ../INCLUDE/TempF90/JunkTempDir/airslevels_upperparam.f

/bin/cp ../INCLUDE/TempF90/Earth/airslevelheights_upper.param  ../INCLUDE/TempF90/JunkTempDir/airslevelheights_upperparam.f; fixcon ../INCLUDE/TempF90/JunkTempDir/airslevelheights_upperparam.f ../INCLUDE/TempF90/airslevelheights_upperparam.f90; rm ../INCLUDE/TempF90/JunkTempDir/airslevelheights_upperparam.f

#/bin/cp ../INCLUDE/TempF90/Earth/kcarta_jpl.param              ../INCLUDE/TempF90/JunkTempDir/kcarta_jplparam.f;             fixcon ../INCLUDE/TempF90/JunkTempDir/kcarta_jplparam.f             ../INCLUDE/TempF90/kcarta_jplparam.f90;             rm ../INCLUDE/TempF90/JunkTempDir/kcarta_jplparam.f
