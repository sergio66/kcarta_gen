...
c caFluxFile gives the file name of the unformatted output
      ...
      SUBROUTINE scatterfluxes_rtspec(raWaves,raaAbs,raVTemp,
...
c actually, this is technically done above)
     ...
     $         iaaRadLayer(iatm,1),iaaRadLayer(iatm,inumlayer)
      ...
      CALL flux_rtspec(raWaves,raVTemp,
...
c >>>>>>>>>>
          ...
          CALL InterpolateFlux(raaDownFlux,iLay,raKCDown,raWaves,iStep)
...
c >>>>>>>>>>
          ...
          CALL InterpolateFlux(raaUpFlux,iLay,raKCUp,raWaves,iStep)
...
c do the integral over z axis (2pi) 
      ...
      DO iLay = 1,iNumLayer+1
        print *,'d: iLay, downflx = ',iLay,raaDownFlux(1,iLay)
        print *,'u: iLay, upflx   = ',iLay,raaUpFlux(1,iLay)
        END DO
