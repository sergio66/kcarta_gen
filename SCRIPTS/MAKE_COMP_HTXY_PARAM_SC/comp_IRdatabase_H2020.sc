...
echo "mkdir PARAM_HT2020 and edit so all reference to H2016 are change to H2020"
echo "mkdir PARAM_HT2020 and edit so all reference to H2016 are change to H2020"
echo "mkdir PARAM_HT2020 and edit so all reference to H2016 are change to H2020"
echo "mkdir PARAM_HT2020 and edit so all reference to H2016 are change to H2020"
...
## I have made couple of extra xsec databases, H2016_XSEC and H2020-g51-63_H20160g64-81_XSEC, remove those listing
...
########## >>>>>  testing (it was crashing because of H2016_XSEC,H2020-g51-63_H20160g64-81_XSEC)
#exit 1
...
sed -e '/ 30  /d' -e '/ 35  /d' -e '/ 41  /d' -e '/42     1180/d' ABCcomp_ir605_2830.param > PARAM_HT2020/comp_ir605_2830.param
echo " ---->>>> deleted gases 30 35 41 42 <<<<<<<<<<<<<---------"
echo " ---->>>> FINAL results are stored in PARAM_HT2020/comp_ir605_2830.param <<<<----"
echo " ---->>>> you may have to check CO2 (the LBLRTM database spans all 89 chunks??) <<<<----"
echo " ---->>>> and can also run eg matlab code compare_databases([[1:42] [51:81]],'PARAM_HT2016/comp_ir605_2830.param','PARAM_HT2020/comp_ir605_2830.param'); <<<<----"
