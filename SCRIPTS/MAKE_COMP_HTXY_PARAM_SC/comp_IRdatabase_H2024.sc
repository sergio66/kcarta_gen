...
echo "mkdir    PARAM_HT2024    and edit so all reference to H2020 are changed to H2024"
echo "mkdir    PARAM_HT2024    and edit so all reference to H2020 are changed to H2024"
echo "mkdir    PARAM_HT2024    and edit so all reference to H2020 are changed to H2024"
echo "mkdir    PARAM_HT2024    and edit so all reference to H2020 are changed to H2024"
...
#first do the water
#cd /asl/data/kcarta/H2024.ieee-le/IR605/hdo.ieee-le/                     ## kWaterPath
cd /umbc/xfs3/strow/asl/rta/kcarta/H2024.ieee-le/IR605/hdo.ieee-le/       ## kWaterPath
...
cd $shome
#cd /asl/data/kcarta/H2024.ieee-le/IR605/etc.ieee-le/                     ##kCompPath
cd /umbc/xfs3/strow/asl/rta/kcarta/H2024.ieee-le/IR605/etc.ieee-le/       ##kCompPath
...
## I have made couple of extra xsec databases, H2016_XSEC and H2024-g51-63_H20160g64-81_XSEC, remove those listing
...
########## >>>>>  testing (it was crashing because of H2016_XSEC,H2024-g51-63_H20160g64-81_XSEC)
#exit 1
...
echo " quit double counting gases 30/81 35/61 41/80 42/54"
sed -e '/ 30  /d' -e '/ 35  /d' -e '/ 41  /d' -e '/42     1180/d' ABCcomp_ir605_2830.param > PARAM_HT2024/comp_ir605_2830.param
echo " ---->>>> deleted gases 30 35 41 42 <<<<<<<<<<<<<---------"
echo " ---->>>> FINAL results are stored in PARAM_HT2024/comp_ir605_2830.param <<<<----"
echo " ---->>>> you may have to check CO2 (the LBLRTM database spans all 89 chunks??) <<<<----"
echo " "
echo " ---->>>> and can also run eg matlab code compare_databases([[1:42] [51:81]],'PARAM_HT2020/comp_ir605_2830.param','PARAM_HT2024/comp_ir605_2830.param'); <<<<----"
echo " "

rm compdatabase_ir605_2830 waterdatabase_ir605_2830 comp1.param
rm othersdatabase_ir605_2830 compdatabase.x compdatabase ABCcomp_ir605_2830.param
