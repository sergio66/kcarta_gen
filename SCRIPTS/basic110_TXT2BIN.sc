:
:
### run this script with basic.sc inTEXTfile outkcBINfile
...
### SYNOPSIS : basic.sc inTEXTfile outkcBINfile
### 
### name of script                        = basic.sc
### path/name of input text point profile = inTEXTfile
...
BIN_KL="/asl/packages/klayers/Bin"        #this is the KLAYERS binary subdir
