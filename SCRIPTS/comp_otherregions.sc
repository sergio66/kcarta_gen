...
#first do the water
cd /spinach/s6/sergio/RUN8_NIRDATABASE/NIR2830_3330/fbin/h2o.ieee-le  ##kWaterPath
...
cd $shome
cd /spinach/s6/sergio/RUN8_NIRDATABASE/NIR2830_3330/fbin/etc.ieee-le  ##kCompPath
...
mv comp.param comp_nir2830_3330.param
echo " ---->>>> results are stored in comp_nir2830_3330.param <<<<----"
